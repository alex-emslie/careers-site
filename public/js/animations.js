(function() {
  ...
  hoverBox = function() {
    ...
    consumerText = "<h1>A white-label technical support solution for all home technology.</h1> <ul class='bullets'><h3>Consumer Technical Support Benefits</h3><li>Onboard, setup and configure IoT devices.</li><li>Cross-sell and up-sell additional services via expert agents.</li><li>Offer full-stack support regardless of manufacturer or problem.</li><li>Support is cost effective with a shared pool of agents.</li></ul>";
    businessText = "<h1>Enterprise-grade support for any hardware, software or cloud IT challenge.</h1> <ul class='bullets'><h3>Business IT Helpdesk Benefits</h3><li>Deliver at Point-of-Need, Point-of-Sale or as bundles.</li><li>Live chat, remote login, and intelligent routing are included.</li><li>Offer additional services like security, backup, and recovery.</li><li>Low cost subscription pricing with full-scope assistance.</li></ul>";
    marketplaceText = "<h1>White label marketplace support that drives user engagement.</h1> <ul class='bullets'><h3>Marketplace Technical Support Benefits</h3><li>Offer first line of support to cloud services discovery and purchasing.</li><li>Expert agents deliver voice and online chat services.</li><li>Cross-sell and up-sell additional apps and support services.</li><li>Go to market faster and increase Gross Merchandise Value.</li></ul>";
    docText = "<h1>Onboarding, activation and professional services for SMBs with Office 365.</h1> <ul class='bullets'><h3>Cloud Services Support for Office 365 Benefits</h3><li>Onboard, activate, and migrate Office 365 users.</li><li>Onboarding users quickly with zero downtime.</li><li>Expert technicians provide front line support.</li><li>Support for provisioning and administrative issues is on-going.</li></ul>";
    $('.box.consumer').on({
      'click': function() {
